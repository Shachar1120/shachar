...
class Pro:
    ...
    RING_ACK = 14
    RING_NACK = 15
    cmds = ["REGISTER", "REGISTER_ACK", "REGISTER_NACK", "ASSIGN", "ASSIGN_ACK", "ASSIGN_NACK", "CONTACTS", "ASSIGNED_CLIENTS", "CALL", "TARGET_ACK", "TARGET_NACK", "ASK_TARGET_DETAILS", "SEND_TARGET_DETAILS", "RING", "RING_ACK", "RING_NACK"]
